...
See `Apama Documentation <https://documentation.softwareag.com/pam/10.15.5.0/en>`_, `Streaming Analytics guide <https://cumulocity.com/docs/streaming-analytics>`_ and `PySys Documentation <https://pysys-test.github.io/pysys-test>`_ for further docs.
